...
// CountEvalCommentsByIssue is a thin pass-through to the store (BACI-141).
// Used by boardcards.Assemble for the per-card eval-notes indicator.
...
// CountTranscriptDocsByIssue is a thin pass-through to the store (BACI-141).
// Used by boardcards.Assemble for the per-card transcript indicator.
