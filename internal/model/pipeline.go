...
var pipelineProcesses = []Process{
	...
	// gate in between.
	{Slug: "scope-plan-implement-ship", Name: "Scope → Plan → Implement → Ship", Stages: []string{BuiltinTemplateScope, BuiltinTemplatePlan, BuiltinTemplateImplement, ShipJobMode}},
