...
// flips ENABLE_TOOL_SEARCH=true. Kept here so the post-install activation
// banner (printActivationBanner) and the `bacio agent-run-command` verb
// emit the exact same string and never drift apart.
//
