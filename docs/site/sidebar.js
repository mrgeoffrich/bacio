...
const rawSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'bacio workspace', link: '/reference/cli/workspace' },
      { text: 'bacio feature', link: '/reference/cli/feature' },
      { text: 'bacio issue', link: '/reference/cli/issue' },
      { text: 'bacio kanban', link: '/reference/cli/kanban' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Kanban and the Agentic Pipeline', link: '/concepts/kanban-and-pipeline' },
      { text: 'Document folders', link: '/concepts/document-folders' },
