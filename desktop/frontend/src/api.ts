...
// opts.transcriptEventRef (BACI-141) anchors the comment to a specific
// event inside a `.jsonl` transcript — set by the per-event composer
// surface; empty leaves the comment dispatch-level anchored.
